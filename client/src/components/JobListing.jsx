    ...
    return (
        <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
            ...
            <div className='w-full lg:w-1/4 bg-white px-4'>
                ...
                {/* Button for sidebar in mobile view */}
                <button onClick={e=> setShowFilter(prev => !prev)} className='px-6 py-1.5 rounded border border-gray-400 lg:hidden'>
                    {showFilter ? "Close" : "Filters"}
                </button>

                {/* Category Filter */}
                <div className={showFilter ? "" : "max-lg:hidden"}> {/*dynamic classname, controls category filter with button above*/}
            ...
            <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
                ...
                {jobs.length > 0 && (
                    <div className='flex items-center justify-center space-x-2 mt-10'>
                        ...
                        <a href="#job-list">
                            <img onClick={() => setCurrentPage(Math.min(currentPage+1, Math.ceil(JobLocations.length / 6)))} src={assets.right_arrow_icon} alt="" />
                        </a>
                    </div>
                )
                }
